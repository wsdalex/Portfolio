...
const Projects = () => {
  ...
  return (
    <>
      <Fade in={show}>
        <Container className="mt-5 section" id="projects">
          <h1>Projects</h1>
          <Row md={4}>
            <Col md={4}>
              <Card>
                  ...
                  <Collapse in={showProject1}>
                    <div>
                      <Card.Text className="mt-3">
                        Makers 64 is a fullstack application written made with
                        the MERN stack. The site features multiple games to play
                        and social media features such as messaging and friends.
                        The design was inspired by Nintendo and Miniclip for a
                        true nostalgic retro feel. The site was deployed on
                        Render.
                      </Card.Text>
                  ...
                  <Collapse in={showProject2}>
                    <div>
                      <Card.Text className="mt-3">
                        ...
                        features of Facebook. Users can create posts and view
                        them on a feed where they can like and comment on them.
                        The user can add and view their friends. Acebook also
                        uses token based authentication for secure sessions.
                      </Card.Text>
                      <h6>Technologies Used:</h6>
                      <ListGroup variant="flush">
                        <ListGroup.Item>React</ListGroup.Item>
